...
public class MavenArtifactRowMapper implements RowMapper<MavenArtifact> {

  @Override
  public MavenArtifact map(ResultSet rs, StatementContext ctx) throws SQLException {
    ...
    return new MavenArtifact(rs.getString("group_id"), rs.getString("artifact_id"), versions);
  }
}
